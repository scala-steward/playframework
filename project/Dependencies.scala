...
object Dependencies {
  ...
  val jpaDeps = Seq(
    ...
    "org.hibernate"       % "hibernate-core"          % "6.6.54.Final" % "test"
  )
  ...
  def runtime(scalaVersion: String) =
    slf4j ++
      Seq("akka-actor", "akka-actor-typed", "akka-slf4j", "akka-serialization-jackson")
        ...
        "at.yawk.lz4" % "lz4-java" % "1.11.1" // CVE‐2025‐12183 + CVE-2025-66566
      ) ++
  ...
  val playFileWatch = "com.typesafe.play" %% "play-file-watch" % "1.2.2"
